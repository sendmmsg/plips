...
plips_val *plips_val_double_new(double val);
plips_val *plips_val_string(char *val);
plips_val *plips_val_symbol(char *val);
plips_val *plips_val_keyword(char *val);
plips_val *plips_val_list();
plips_val *plips_val_hash(zhashx_t *val);
plips_val *plips_val_atom(plips_val *val);
plips_val *plips_val_function(void *(*func)(void *), int arg_cnt);
