...
all:plips
plips: linenoise.c plips.c plips_env.c plips_val.c plips_reader.c encodings/utf8.c plips_core.c
	$(GCC) $(GCCOPTS) -o plips linenoise.c plips.c plips_env.c plips_val.c plips_reader.c plips_core.c encodings/utf8.c -lpcre -lczmq
